 ...
 * @author gonzalowtf
 */
public class addDecisor extends javax.swing.JInternalFrame {

    /**
     * Creates new form addDecisor
     */
    int idproblem =0;
    public addDecisor(String name) {
        initComponents();
        
        setTitle("Add a new Decisor to "+name.substring(1)+ " ?");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter Decisor name:");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if(this.jTextField1.getText().isEmpty()){
             JOptionPane.showMessageDialog(null, "Please Enter a Decisor name  ");
     ...
     if(this.jTextField1.getText().contains(" ")){
        ...
        Conn cn = new Conn(url);
        cn.stmt = cn.c.createStatement();
        String sql = "insert into decisors values (null, '"+name.trim().toUpperCase()+"', "+idproblem+")";
        cn.stmt.executeUpdate(sql);
        JOptionPane.showMessageDialog(null, "Decisor Added");
        this.hide();
        }catch(SQLException err){
                    JOptionPane.showMessageDialog(null, "Data Base Connection Problem (new p 208) "+ err.toString());
                }
